...
public class FvmFacade {
	 ...
	 *            The transition system being tested.
	 * @param e
	 *            The sequence that may or may not be an execution of {@code ts}.
	 ...
	 *            The transition system being tested.
	 * @param e
	 *            The sequence that may or may not be an initial execution fragment
	 *            of {@code ts}.
	 * @return {@code true} iff {@code e} is an execution fragment of {@code ts}.
	 */
	 ...
	 *            The transition system being tested.
	 * @param e
	 *            The sequence that may or may not be a maximal execution fragment
	 *            of {@code ts}.
	 ...
	 *             if {@code s} is not a state of {@code ts}.
	 */
	 ...
	 *            The transition system.
	 * @param aut
	 *            A Büchi automaton for the words that do not satisfy the property.
